...
ActiveRecord::Schema.define(version: 20170829124809) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string   "first_name"
    t.string   "last_name"
    t.string   "recast_sender_id"
    t.index ["recast_sender_id"], name: "index_users_on_recast_sender_id", unique: true, using: :btree
